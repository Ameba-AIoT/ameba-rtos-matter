...
cp ${amebadir}/component/application/matter/tools/docker/ameba-rtos/amebadplus/inc/km0/platform_autoconf.h ${amebadir}/amebadplus_gcc_project/menuconfig/project_km0/
cp ${amebadir}/component/application/matter/tools/docker/ameba-rtos/amebadplus/inc/km4/platform_autoconf.h ${amebadir}/amebadplus_gcc_project/menuconfig/project_km4/
