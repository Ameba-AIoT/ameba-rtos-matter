...
cp ${amebadir}/component/application/matter/tools/docker/ameba-rtos/v1.1/config/amebadplus_lite_matter_proj.conf ${amebadir}/amebalite_gcc_project/matter_proj.conf
