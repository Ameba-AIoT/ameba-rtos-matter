...
The generated image is found in the ameba-rtos sdk `ameba-rtos-matter/build_RTL8730E/`, both `km4_boot_all.bin` and `km0_km4_ca32_app.bin` will be flashed.
