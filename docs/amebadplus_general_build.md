...
The generated image is found in the ameba-rtos sdk `ameba-rtos-matter/build_RTL8721Dx/`, both `km4_boot_all.bin` and `km0_km4_app.bin` will be flashed.
