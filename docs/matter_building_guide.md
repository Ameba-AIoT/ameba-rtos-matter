...
```bash
make -C project_km4/asdk all_clusters / air_purifier / aircon_port / bridge_dm / bridge_port / dishwasher_port / energy_management_port /
...
```bash
make -C project_ap/asdk all_clusters / air_purifier / aircon_port / bridge_dm / bridge_port / dishwasher_port / energy_management_port /
                         fan_port / laundrywasher_port / light_dm / light_port / microwaveoven_port / refrigerator_port / thermostat_port
```
