...
| RTL8721F  |![alt text][supported]      | ameba-rtos/release/* |
...
**Matter v1.6 and v1.5** is associated with the following SDKs:
- AmebaRTOS SDK: [ameba-rtos:release/v1.2](https://github.com/Ameba-AIoT/ameba-rtos/tree/release/v1.2)

| Matter Version | ameba-rtos branch | ameba-rtos-matter version | connectedhomeip version |
|----------------|-------------------|---------------------------|-------------------------|
| Matter v1.6    | release/v1.2      | ameba-rtos/release/v1.6   | v1.6-branch             |
| Matter v1.5    | release/v1.2      | ameba-rtos/release/v1.5   | v1.5-branch             |
