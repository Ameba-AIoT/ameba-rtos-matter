...
This example demonstrates an implementation of the **Matter Thermostat** device type.

## 📘 ZAP Configuration

- **ZAP File:** `thermostat-app.zap`
  Located under `connectedhomeip/examples/thermostat/thermostat-common/thermostat.zap`
- **Device Type ID:** `0x0301` (Matter Thermostat)
...
|-----------------|------------------------|-----------------|
| **1** | Thermostat | Main functional endpoint for the thermostat device |
...
| **Thermostat** | Provides temperature setpoint control and regulation | Server |
| **Thermostat User Interface Configuration** | Handles UI-related control features such as mode selection, display updates, and operational feedback | Server |
...
|----------------|-------------|----------------------------|
| `matter_driver_thermostat_init()` | Device initialization | Initializes the device hardware for **Thermostat** device |
| `matter_driver_thermostat_ui_init()` | Startup configuration | Initializes the device hardware for **Thermostat User Interface** device |
| `matter_driver_thermostat_ui_set_startup_value()` | Operational state callback | Sets initial values for the thermostat UI clusters and synchronizes Matter attributes with the device’s hardware state |
...
|----------------|-----------------|
| **ZAP File** | `thermostat-app.zap` |
| **Main Example File** | `example_matter_thermostat.cpp` |
| **Main Matter Driver File** | `matter_drivers.cpp` |
| **Main Device Driver File** | `thermostat_driver.cpp` `thermostat_ui_driver.cpp` |
