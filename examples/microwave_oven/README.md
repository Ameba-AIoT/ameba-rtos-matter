# Matter Microwave Oven Example

This example demonstrates an implementation of the **Matter Microwave Oven** device type.

## 📘 ZAP Configuration

- **ZAP File:** `microwave-oven-app.zap`
- **Device Type ID:** `0x0079` (Matter Microwave Oven)
...
|-----------------|------------------------|-----------------|
| **1** | Microwave Oven | Main functional endpoint for the microwave oven device |
...
| **Operational State** | Reports the current operational state | Server |
| **Microwave Oven Mode** | Defines available cooking modes | Server |
| **Microwave Oven Control** | Handles control functions| Server |
...
|----------------|-------------|----------------------------|
| `matter_driver_microwave_oven_init()` | Device initialization | Initializes the device hardware for **Microwave Oven** device |
| `matter_driver_microwave_oven_set_startup_value()` | Startup configuration | Sets initial values for the microwave oven clusters and synchronizes Matter attributes with the device’s hardware state |
...
|----------------|-----------------|
| **ZAP File** | `microwave-oven-app.zap` |
| **Main Example File** | `example_matter_microwave_oven.cpp` |
| **Main Matter Driver File** | `matter_drivers.cpp` |
| **Main Device Driver File** | `microwaveoven_driver.cpp` |
| **Cluster Implementation File** | `ameba_microwave_oven_device.cpp` |
...
### Build Matter Libraries
    ...
    cd amebaz2_sdk/component/common/application/matter/example/microwaveoven
    make microwave_oven_port
...
### Build Matter Libraries
    ...
    make -C asdk microwave_oven_port
