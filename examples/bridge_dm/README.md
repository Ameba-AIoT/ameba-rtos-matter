...
- The ZAP-CLI will generate 3 endpoints based on the ZAP file (bridge-app.zap).
- Since there are 3 endpoints, FIXED_ENDPOINT_COUNT will be set to 3.
- However, the last fixed endpoint is Placeholder, so LAST_FIXED_ENDPOINT_ID is 2.
