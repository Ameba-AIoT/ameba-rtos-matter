...
### Configurations
`CONFIG_EXAMPLE_MATTER` and `CONFIG_EXAMPLE_MATTER_LAUNDRY_WASHER` are automatically enabled in the Makefiles / CMake.
...
#### Build Matter Libraries and the Final Firmware
    ...
    matter_build_proj laundrywasher_port
...
#### Build Matter Libraries
    ...
    cd ameba-rtos/amebadplus_gcc_project
    make -C project_km4/asdk laundrywasher_port
...
#### Build Matter Libraries
    ...
    cd ameba-rtos/amebasmart_gcc_project
    make -C project_ap/asdk laundrywasher_port
