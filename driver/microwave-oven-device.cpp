...
void ExampleMicrowaveOvenDevice::MicrowaveOvenInit(void)
{
 ...
 */
app::DataModel::Nullable<uint32_t> ExampleMicrowaveOvenDevice::GetCountdownTime(void)
{
 ...
 */
CHIP_ERROR ExampleMicrowaveOvenDevice::Init(void)
{
    return CHIP_NO_ERROR;
}
...
void MatterMicrowaveOvenServerInit(void)
{
...
void MatterMicrowaveOvenServerShutdown(void)
{
    gMicrowaveOvenDevice = nullptr;
}

ExampleMicrowaveOvenDevice *GetMatterMicrowaveOvenServer(void)
{
