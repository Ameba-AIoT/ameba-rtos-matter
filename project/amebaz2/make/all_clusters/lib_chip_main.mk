...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_air_quality_instance.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_bridged_actions_stubs.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_charging_targets_mem_manager.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_concentration_measurement_instances.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_device_energy_management_delegate_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_device_energy_management_manager.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_device_energy_management_mode.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_device_energy_management_stub.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_dishwasher_alarm_stubs.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_dishwasher_mode.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_electrical_energy_measurement_stubs.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_electrical_power_measurement.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_electrical_power_measurement_stub.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_evse_delegate_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_evse_manufacturer_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_evse_manager.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_evse_mode.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_evse_stub.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_evse_targets_store.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_preference_delegate.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_energy_time_utils.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_fan_stubs.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_laundry_dryer_controls_delegate_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_laundry_washer_controls_delegate_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_laundry_washer_mode.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_microwave_oven_device.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_microwave_oven_mode.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_modes_manager.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_occupancy_sensing.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_operational_state_delegate_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_oven_modes.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_oven_operational_state_delegate.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_power_topology_delegate.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_power_topology_stub.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_resource_monitoring_delegate.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_rvc_modes.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_rvc_operational_state_delegate_impl.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_smco_stub.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_switch.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_tcc_mode.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_temperature_levels.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_valve_control_delegate.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_water_heater_management_delegate.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_water_heater_management_instance.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_water_heater_management_main.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_water_heater_management_manufacturer.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/matter_drivers/matter_water_heater_mode.cpp
