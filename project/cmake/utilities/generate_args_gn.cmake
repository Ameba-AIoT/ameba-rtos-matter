...
if(CHIP_ENABLE_ICD)
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_enable_icd_server = true\n")
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_icd_report_on_active_mode = true\n")
else()
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_enable_icd_server = false\n")
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_icd_report_on_active_mode = false\n")
endif()

if(CHIP_ENABLE_ICD_LIT)
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_enable_icd_lit = true\n")
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_enable_icd_dsls = true\n")
else()
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_enable_icd_lit = false\n")
	file(APPEND ${OUTPUT_DIR}/args.gn "chip_enable_icd_dsls = false\n")
endif()
