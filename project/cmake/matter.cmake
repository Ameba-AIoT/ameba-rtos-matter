...
set(MATTER_DIR         "${EXAMPLEDIR}")
elseif(CONFIG_AMEBARTOS_V1_1)
...
if(CONFIG_MATTER_ENABLE_TCP_ENDPOINT)
    message(STATUS "Enabling TCP Endpoint for Matter")
    set(CHIP_ENABLE_TCP_ENDPOINT ON)
else()
    message(STATUS "Disabling TCP Endpoint for Matter")
    set(CHIP_ENABLE_TCP_ENDPOINT OFF)
endif()

#OTA is disabled for bridge_port, evse_port, and water_heater_port example zap
if((MATTER_EXAMPLE STREQUAL "bridge_port") OR (MATTER_EXAMPLE STREQUAL "evse_port") OR (MATTER_EXAMPLE STREQUAL "water_heater_port"))
...
#----------------------------------------#
set(ALL_CLUSTERS_OUTPUT_DIR           "${CHIP_DIR}/examples/all-clusters-app/ameba/build_${c_SOC_TYPE}/chip")
...
set(AIR_PURIFIER_OUTPUT_DIR           "${CHIP_DIR}/examples/air-purifier-app/ameba/build_${c_SOC_TYPE}/chip")
...
set(BRIDGE_PORT_OUTPUT_DIR            "${CHIP_DIR}/examples/bridge-app/ameba/build_${c_SOC_TYPE}/chip")
...
set(EVSE_PORT_OUTPUT_DIR              "${CHIP_DIR}/examples/evse-app/ameba/build_${c_SOC_TYPE}/chip")
set(EVSE_PORT_ZAP                     "${CHIP_DIR}/examples/evse-app/evse-common/evse-app.zap")
set(EVSE_PORT_MATTER                  "${CHIP_DIR}/examples/evse-app/evse-common/evse-app.matter")
set(EVSE_PORT_FILE                    "${EVSE_PORT_OUTPUT_DIR}/codegen/cluster-file.txt")
set(LIGHTING_OUTPUT_DIR               "${CHIP_DIR}/examples/lighting-app/ameba/build_${c_SOC_TYPE}/chip")
...
set(THERMOSTAT_PORT_OUTPUT_DIR        "${CHIP_DIR}/examples/thermostat/ameba/build_${c_SOC_TYPE}/chip")
...
set(WATER_HEATER_PORT_OUTPUT_DIR      "${CHIP_DIR}/examples/water-heater-app/ameba/build_${c_SOC_TYPE}/chip")
set(WATER_HEATER_PORT_ZAP             "${CHIP_DIR}/examples/water-heater-app/water-heater-common/water-heater-app.zap")
set(WATER_HEATER_PORT_MATTER          "${CHIP_DIR}/examples/water-heater-app/water-heater-common/water-heater-app.matter")
set(WATER_HEATER_PORT_FILE            "${WATER_HEATER_PORT_OUTPUT_DIR}/codegen/cluster-file.txt")

set(AIRCON_PORT_OUTPUT_DIR            "${MATTER_EXAMPLE_DIR}/aircon/build_${c_SOC_TYPE}/chip")
...
set(BRIDGE_DM_OUTPUT_DIR              "${MATTER_EXAMPLE_DIR}/bridge_dm/build_${c_SOC_TYPE}/chip")
...
set(CAMERA_PORT_OUTPUT_DIR            "${MATTER_EXAMPLE_DIR}/camera/build_${c_SOC_TYPE}/chip")
set(CAMERA_PORT_FILE                  "${CAMERA_PORT_OUTPUT_DIR}/codegen/cluster-file.txt")
set(CAMERA_PORT_ZAP                   "${MATTER_EXAMPLE_DIR}/camera/camera-app.zap")
set(CAMERA_PORT_MATTER                "${MATTER_EXAMPLE_DIR}/camera/camera-app.matter")
set(DISHWASHER_PORT_OUTPUT_DIR        "${MATTER_EXAMPLE_DIR}/dishwasher/build_${c_SOC_TYPE}/chip")
...
set(DOORLOCK_PORT_OUTPUT_DIR          "${MATTER_EXAMPLE_DIR}/doorlock/build_${c_SOC_TYPE}/chip")
set(DOORLOCK_PORT_FILE                "${DOORLOCK_PORT_OUTPUT_DIR}/codegen/cluster-file.txt")
set(DOORLOCK_PORT_ZAP                 "${MATTER_EXAMPLE_DIR}/doorlock/door-lock-app.zap")
set(DOORLOCK_PORT_MATTER              "${MATTER_EXAMPLE_DIR}/doorlock/door-lock-app.matter")
set(FAN_PORT_OUTPUT_DIR               "${MATTER_EXAMPLE_DIR}/fan/build_${c_SOC_TYPE}/chip")
...
set(LAUNDRYWASHER_PORT_OUTPUT_DIR     "${MATTER_EXAMPLE_DIR}/laundrywasher/build_${c_SOC_TYPE}/chip")
...
set(LIGHTING_DM_OUTPUT_DIR            "${MATTER_EXAMPLE_DIR}/light_dm/build_${c_SOC_TYPE}/chip")
...
set(MICROWAVEOVEN_PORT_OUTPUT_DIR     "${MATTER_EXAMPLE_DIR}/microwaveoven/build_${c_SOC_TYPE}/chip")
...
set(REFRIGERATOR_PORT_OUTPUT_DIR      "${MATTER_EXAMPLE_DIR}/refrigerator/build_${c_SOC_TYPE}/chip")
...
elseif(MATTER_EXAMPLE STREQUAL "camera_port")
    set(CLUSTER_FILE ${CAMERA_PORT_FILE})
    set(ZAP_FILE     ${CAMERA_PORT_ZAP})
    set(MATTER_FILE  ${CAMERA_PORT_MATTER})
    set(OUTPUT_DIR   ${CAMERA_PORT_OUTPUT_DIR})
...
elseif(MATTER_EXAMPLE STREQUAL "doorlock_port")
    set(CLUSTER_FILE ${DOORLOCK_PORT_FILE})
    set(ZAP_FILE     ${DOORLOCK_PORT_ZAP})
    set(MATTER_FILE  ${DOORLOCK_PORT_MATTER})
    set(OUTPUT_DIR   ${DOORLOCK_PORT_OUTPUT_DIR})
elseif(MATTER_EXAMPLE STREQUAL "evse_port")
    set(CLUSTER_FILE ${EVSE_PORT_FILE})
    set(ZAP_FILE     ${EVSE_PORT_ZAP})
    set(MATTER_FILE  ${EVSE_PORT_MATTER})
    set(OUTPUT_DIR   ${EVSE_PORT_OUTPUT_DIR})
...
elseif(MATTER_EXAMPLE STREQUAL "water_heater_port")
    set(CLUSTER_FILE ${WATER_HEATER_PORT_FILE})
    set(ZAP_FILE     ${WATER_HEATER_PORT_ZAP})
    set(MATTER_FILE  ${WATER_HEATER_PORT_MATTER})
    set(OUTPUT_DIR   ${WATER_HEATER_PORT_OUTPUT_DIR})
else()
