...
set(MATTER_DRIVER_DIR  "${MATTER_DIR}/drivers/matter_drivers")
...
if(DM_EXAMPLE EQUAL -1)
    message(STATUS "${MATTER_EXAMPLE} is not porting layer DM example")
    set(PORTING_LAYER_DM_EXAMPLE OFF)
else()
    message(STATUS "${MATTER_EXAMPLE} is porting layer DM example")
    set(PORTING_LAYER_DM_EXAMPLE ON)
endif()
