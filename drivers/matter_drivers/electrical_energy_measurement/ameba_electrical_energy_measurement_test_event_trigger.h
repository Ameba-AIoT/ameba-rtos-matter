 ...
 */
bool AmebaHandleEnergyReportingTestEventTrigger(uint64_t eventTrigger);
...
class AmebaEnergyReportingTestEventTriggerHandler : public TestEventTriggerHandler
{
public:
    AmebaEnergyReportingTestEventTriggerHandler() {}

    CHIP_ERROR HandleEventTrigger(uint64_t eventTrigger) override
    {
        if (AmebaHandleEnergyReportingTestEventTrigger(eventTrigger))
        {
