...
static void EndSelfTestingEventHandler(System::Layer * systemLayer, void * appState)
{
    ...
    ChipLogProgress(Support, "[Smoke-CO-Alarm] => Self Test completed");
}

void AmebaSmokeCoAlarmEvent::SelfTestingEventHandler(void)
{
...
CHIP_ERROR SmokeCoAlarm::AmebaSmokeCoAlarmTestEventInit(EndpointId endpoint)
{
