...
AmebaLockManager AmebaLockManager::instance;
...
bool AmebaLockManager::InitEndpoint(chip::EndpointId endpointId)
{
    ...
    mEndpoints.emplace_back(std::make_unique<AmebaLockEndpoint>(endpointId, numberOfSupportedUsers, numberOfSupportedCredentials,
...
bool AmebaLockManager::SetDoorState(chip::EndpointId endpointId, DoorStateEnum doorState)
{
...
bool AmebaLockManager::SendLockAlarm(chip::EndpointId endpointId, AlarmCodeEnum alarmCode)
{
    auto lockEndpoint = getEndpoint(endpointId);
    if (nullptr == lockEndpoint)
    {
...
bool AmebaLockManager::Lock(chip::EndpointId endpointId, const Nullable<chip::FabricIndex> & fabricIdx,
...
bool AmebaLockManager::Unlock(chip::EndpointId endpointId, const Nullable<chip::FabricIndex> & fabricIdx,
                         const Nullable<chip::NodeId> & nodeId, const Optional<chip::ByteSpan> & pin, OperationErrorEnum & err,
                         OperationSourceEnum opSource)
{
    auto lockEndpoint = getEndpoint(endpointId);
...
bool AmebaLockManager::Unbolt(chip::EndpointId endpointId, const Nullable<chip::FabricIndex> & fabricIdx,
                         const Nullable<chip::NodeId> & nodeId, const Optional<chip::ByteSpan> & pin, OperationErrorEnum & err,
                         OperationSourceEnum opSource)
{
    auto lockEndpoint = getEndpoint(endpointId);
...
bool AmebaLockManager::GetUser(chip::EndpointId endpointId, uint16_t userIndex, EmberAfPluginDoorLockUserInfo & user)
{
    auto lockEndpoint = getEndpoint(endpointId);
    if (nullptr == lockEndpoint)
    {
...
bool AmebaLockManager::SetUser(chip::EndpointId endpointId, uint16_t userIndex, chip::FabricIndex creator, chip::FabricIndex modifier,
...
bool AmebaLockManager::GetCredential(chip::EndpointId endpointId, uint16_t credentialIndex, CredentialTypeEnum credentialType,
...
bool AmebaLockManager::SetCredential(chip::EndpointId endpointId, uint16_t credentialIndex, chip::FabricIndex creator,
...
bool AmebaLockManager::InitAdmin(chip::EndpointId endpointId)
{
    // Refer to 5.2.10.34. SetUser Command, when Create a new user record
    ...
    const chip::CharSpan userName = chip::CharSpan::fromCharString("admin"); // default
                                                                             // username
...
DlStatus AmebaLockManager::GetSchedule(chip::EndpointId endpointId, uint8_t weekDayIndex, uint16_t userIndex,
...
DlStatus AmebaLockManager::SetSchedule(chip::EndpointId endpointId, uint8_t weekDayIndex, uint16_t userIndex, DlScheduleStatus status,
...
DlStatus AmebaLockManager::GetSchedule(chip::EndpointId endpointId, uint8_t yearDayIndex, uint16_t userIndex,
...
DlStatus AmebaLockManager::SetSchedule(chip::EndpointId endpointId, uint8_t yearDayIndex, uint16_t userIndex, DlScheduleStatus status,
...
DlStatus AmebaLockManager::GetSchedule(chip::EndpointId endpointId, uint8_t holidayIndex,
...
DlStatus AmebaLockManager::SetSchedule(chip::EndpointId endpointId, uint8_t holidayIndex, DlScheduleStatus status,
...
AmebaLockEndpoint * AmebaLockManager::getEndpoint(chip::EndpointId endpointId)
{
