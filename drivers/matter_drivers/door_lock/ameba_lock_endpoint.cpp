...
bool AmebaLockEndpoint::Lock(const Nullable<chip::FabricIndex> & fabricIdx, const Nullable<chip::NodeId> & nodeId,
...
bool AmebaLockEndpoint::Unlock(const Nullable<chip::FabricIndex> & fabricIdx, const Nullable<chip::NodeId> & nodeId,
                          const Optional<chip::ByteSpan> & pin, OperationErrorEnum & err, OperationSourceEnum opSource)
{
...
bool AmebaLockEndpoint::Unbolt(const Nullable<chip::FabricIndex> & fabricIdx, const Nullable<chip::NodeId> & nodeId,
                          const Optional<chip::ByteSpan> & pin, OperationErrorEnum & err, OperationSourceEnum opSource)
{
    return setLockState(fabricIdx, nodeId, DlLockState::kUnlocked, pin, err, opSource);
}

bool AmebaLockEndpoint::GetUser(uint16_t userIndex, EmberAfPluginDoorLockUserInfo & user) const
{
    ChipLogProgress(Zcl, "Lock App: AmebaLockEndpoint::GetUser [endpoint=%d,userIndex=%hu]", mEndpointId, userIndex);
...
bool AmebaLockEndpoint::SetUser(uint16_t userIndex, chip::FabricIndex creator, chip::FabricIndex modifier,
                           const chip::CharSpan & userName, uint32_t uniqueId, UserStatusEnum userStatus, UserTypeEnum usertype,
                           CredentialRuleEnum credentialRule, const CredentialStruct * credentials, size_t totalCredentials)
{
    ChipLogProgress(
        Zcl,
        "Lock App: AmebaLockEndpoint::SetUser "
...
DoorStateEnum AmebaLockEndpoint::GetDoorState() const
{
    return mDoorState;
}

bool AmebaLockEndpoint::SetDoorState(DoorStateEnum newState)
{
...
bool AmebaLockEndpoint::SendLockAlarm(AlarmCodeEnum alarmCode) const
{
...
bool AmebaLockEndpoint::GetCredential(uint16_t credentialIndex, CredentialTypeEnum credentialType,
                                 EmberAfPluginDoorLockCredentialInfo & credential) const
{
    ChipLogProgress(Zcl, "Lock App: AmebaLockEndpoint::GetCredential [endpoint=%d,credentialIndex=%u,credentialType=%u]", mEndpointId,
...
bool AmebaLockEndpoint::SetCredential(uint16_t credentialIndex, chip::FabricIndex creator, chip::FabricIndex modifier,
                                 DlCredentialStatus credentialStatus, CredentialTypeEnum credentialType,
                                 const chip::ByteSpan & credentialData)
{
    ChipLogProgress(
        Zcl,
        "Lock App: AmebaLockEndpoint::SetCredential "
...
DlStatus AmebaLockEndpoint::GetSchedule(uint8_t weekDayIndex, uint16_t userIndex, EmberAfPluginDoorLockWeekDaySchedule & schedule)
{
...
DlStatus AmebaLockEndpoint::SetSchedule(uint8_t weekDayIndex, uint16_t userIndex, DlScheduleStatus status, DaysMaskMap daysMask,
...
DlStatus AmebaLockEndpoint::GetSchedule(uint8_t yearDayIndex, uint16_t userIndex, EmberAfPluginDoorLockYearDaySchedule & schedule)
{
...
DlStatus AmebaLockEndpoint::SetSchedule(uint8_t yearDayIndex, uint16_t userIndex, DlScheduleStatus status, uint32_t localStartTime,
...
DlStatus AmebaLockEndpoint::GetSchedule(uint8_t holidayIndex, EmberAfPluginDoorLockHolidaySchedule & schedule)
{
...
DlStatus AmebaLockEndpoint::SetSchedule(uint8_t holidayIndex, DlScheduleStatus status, uint32_t localStartTime, uint32_t localEndTime,
...
CHIP_ERROR AmebaLockEndpoint::GetAliroReaderVerificationKey(MutableByteSpan & verificationKey)
{
...
CHIP_ERROR AmebaLockEndpoint::GetAliroReaderGroupIdentifier(MutableByteSpan & groupIdentifier)
{
    if (!mAliroStateInitialized)
    {
...
CHIP_ERROR AmebaLockEndpoint::GetAliroReaderGroupSubIdentifier(MutableByteSpan & groupSubIdentifier)
{
...
CHIP_ERROR AmebaLockEndpoint::GetAliroExpeditedTransactionSupportedProtocolVersionAtIndex(size_t index,
...
CHIP_ERROR AmebaLockEndpoint::GetAliroGroupResolvingKey(MutableByteSpan & groupResolvingKey)
{
    if (!mAliroStateInitialized)
    {
...
CHIP_ERROR AmebaLockEndpoint::GetAliroSupportedBLEUWBProtocolVersionAtIndex(size_t index, MutableByteSpan & protocolVersion)
{
    // Only claim support for the one known protocol version for now: 0x0100.
    constexpr uint16_t knownProtocolVersion = 0x0100;
...
uint8_t AmebaLockEndpoint::GetAliroBLEAdvertisingVersion()
{
    // For now the only define value of the BLE advertising version for Aliro is 0.
    return 0;
}

uint16_t AmebaLockEndpoint::GetNumberOfAliroCredentialIssuerKeysSupported()
{
    using namespace chip::app::Clusters::DoorLock;
...
uint16_t AmebaLockEndpoint::GetNumberOfAliroEndpointKeysSupported()
{
    using namespace chip::app::Clusters::DoorLock;
...
CHIP_ERROR AmebaLockEndpoint::SetAliroReaderConfig(const ByteSpan & signingKey, const ByteSpan & verificationKey,
...
CHIP_ERROR AmebaLockEndpoint::ClearAliroReaderConfig()
{
...
bool AmebaLockEndpoint::setLockState(const Nullable<chip::FabricIndex> & fabricIdx, const Nullable<chip::NodeId> & nodeId,
...
void AmebaLockEndpoint::OnLockActionCompleteCallback(chip::System::Layer *, void * callbackContext)
{
...
bool AmebaLockEndpoint::weekDayScheduleForbidsAccess(uint16_t userIndex, bool * haveSchedule) const
{
...
bool AmebaLockEndpoint::yearDayScheduleForbidsAccess(uint16_t userIndex, bool * haveSchedule) const
{
...
const char * AmebaLockEndpoint::lockStateToString(DlLockState lockState) const
{
    switch (lockState)
    {
