...
class AmebaLockEndpoint : public chip::app::Clusters::DoorLock::Delegate
{
public:
    AmebaLockEndpoint(chip::EndpointId endpointId, uint16_t numberOfLockUsersSupported, uint16_t numberOfCredentialsSupported,
