...
class AmebaWaterHeaterManagementTestEventTriggerHandler : public TestEventTriggerHandler
{
public:
    AmebaWaterHeaterManagementTestEventTriggerHandler() {}

    CHIP_ERROR HandleEventTrigger(uint64_t eventTrigger) override
    {
        if (AmebaHandleWaterHeaterManagementTestEventTrigger(eventTrigger))
        {
