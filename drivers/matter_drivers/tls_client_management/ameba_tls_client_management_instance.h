...
struct TlsEndpointId {
    ...
    void Clear()
    {
        mEndpointId = kUndefinedTlsEndpointId;
    }

    bool IsValid()
    {
        return (mEndpointId != kUndefinedTlsEndpointId);
    }

    bool operator==(const TlsEndpointId &other) const
    {
...
public:
    ...
    static inline TlsClientManagementCommandDelegate &GetInstance()
    {
        return instance;
    }
};
